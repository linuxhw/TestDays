...
|----------------------|----------|---------|
| 5.10.3-arch1-1       | 4        | 5.88%   |
| 5.9.14-arch1-1       | 3        | 4.41%   |
| 5.7.12-arch1-1       | 3        | 4.41%   |
| 5.9.1-arch1-1        | 2        | 2.94%   |
| 5.8.7-arch1-1        | 2        | 2.94%   |
| 5.16.12-arch1-1      | 2        | 2.94%   |
| 5.11.7-arch1-1       | 2        | 2.94%   |
| 5.10.4-arch2-1       | 2        | 2.94%   |
| 5.10.13-arch1-1      | 2        | 2.94%   |
| 6.0.6-arch1-1        | 1        | 1.47%   |
| 5.9.6-arch1-1        | 1        | 1.47%   |
| 5.9.3-arch1-1        | 1        | 1.47%   |
| 5.9.2-arch1-1        | 1        | 1.47%   |
| 5.9.13-arch1-1       | 1        | 1.47%   |
| 5.9.12-arch1-1       | 1        | 1.47%   |
| 5.9.11-arch2-1       | 1        | 1.47%   |
| 5.8.6-arch1-1        | 1        | 1.47%   |
| 5.8.5-arch1-1        | 1        | 1.47%   |
| 5.8.14-arch1-1       | 1        | 1.47%   |
| 5.8.12-arch1-1       | 1        | 1.47%   |
| 5.8.1-arch1-1        | 1        | 1.47%   |
| 5.7.6-arch1-1-custom | 1        | 1.47%   |
| 5.7.11-arch1-1       | 1        | 1.47%   |
| 5.7.10-arch1-1       | 1        | 1.47%   |
| 5.6.3-arch1-1        | 1        | 1.47%   |
| 5.6.2-arch1-2        | 1        | 1.47%   |
| 5.5.9-arch1-2        | 1        | 1.47%   |
| 5.5.5-arch1-1        | 1        | 1.47%   |
| 5.5.2-arch1-1        | 1        | 1.47%   |
| 5.5.11-arch1-1       | 1        | 1.47%   |
| 5.4.6-arch3-1        | 1        | 1.47%   |
| 5.4.10-arch1-1       | 1        | 1.47%   |
| 5.3.7-arch1-2-ARCH   | 1        | 1.47%   |
| 5.3.5-arch1-1-ARCH   | 1        | 1.47%   |
| 5.3.11-arch1-1       | 1        | 1.47%   |
| 5.2.9-arch1-1-ARCH   | 1        | 1.47%   |
| 5.19.7-arch1-1       | 1        | 1.47%   |
| 5.19.6-arch1-1       | 1        | 1.47%   |
| 5.18.9-arch1-1       | 1        | 1.47%   |
| 5.16.0-zen1-1-zen    | 1        | 1.47%   |
...
|---------------------|----------|--------|---------|
| WDC                 | 28       | 36     | 23.14%  |
| Samsung Electronics | 18       | 20     | 14.88%  |
| Seagate             | 17       | 23     | 14.05%  |
| Toshiba             | 8        | 9      | 6.61%   |
| Phison              | 6        | 7      | 4.96%   |
| Hitachi             | 6        | 6      | 4.96%   |
...
| Seagate Expansion Desk 8TB       | 2        | 1.47%   |
...
| MSI PRO 22X 10M MSI1462 1920x1080 595x336mm 26.9-inch                   | 2        | 2.63%   |
...
| Sceptre Tech Sceptre M25 SPT0A05 1920x1080 597x336mm 27.0-inch          | 1        | 1.32%   |
...
| Samsung Electronics LCD Monitor SAM094E 1920x1080 890x500mm 40.2-inch   | 1        | 1.32%   |
...
| Hewlett-Packard x23LED HWP2912 1920x1080 510x290mm 23.1-inch            | 1        | 1.32%   |
