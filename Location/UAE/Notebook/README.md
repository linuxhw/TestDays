...
| HP            | ENVY Laptop 13-aq0xxx       | [c8b1606e4e](https://linux-hardware.org/?probe=c8b1606e4e) | Feb 16, 2020 |
...
| I-Life Digital Technologies | 1         | 1.35%   |
| Apple                       | 1         | 1.35%   |
...
| Samsung MZVLB512HAJQ-000L7 512GB       | 1         | 1.15%   |
...
| Intel Core m5-6Y54 CPU @ 1.10GHz              | 1         | 1.35%   |
...
| Dell U2721DE DEL41DD 2560x1440 597x336mm 27.0-inch                       | 1         | 1.22%   |
...
| Intel Centrino Wireless-N 135                                     | 1         | 0.76%   |
...
| Intel Bluetooth 9460/9560 Jefferson Peak (JfP)  | 10        | 17.54%  |
...
| Toshiba Integrated Bluetooth HCI                | 1         | 1.75%   |
...
| Model                                                                                             | Notebooks | Percent |
|---------------------------------------------------------------------------------------------------|-----------|---------|
| Intel Sunrise Point-LP HD Audio                                                                   | 13        | 12.75%  |
| Intel 7 Series/C216 Chipset Family High Definition Audio Controller                               | 9         | 8.82%   |
| Intel Haswell-ULT HD Audio Controller                                                             | 7         | 6.86%   |
| Intel Cannon Point-LP High Definition Audio Controller                                            | 7         | 6.86%   |
| Intel 8 Series HD Audio Controller                                                                | 7         | 6.86%   |
...
| Intel CM238 HD Audio Controller                                                                   | 2         | 1.96%   |
| AMD Renoir Radeon High Definition Audio Controller                                                | 2         | 1.96%   |
| Nvidia TU104 HD Audio Controller                                                                  | 1         | 0.98%   |
| Logitech USB Headset                                                                              | 1         | 0.98%   |
| Lenovo ThinkPad Thunderbolt 3 Dock USB Audio                                                      | 1         | 0.98%   |
...
| Intel Atom/Celeron/Pentium Processor x5-E8000/J3xxx/N3xxx Series Low Power Engine Audio           | 1         | 0.98%   |
...
| SK Hynix RAM HMA82GS6DJR8N-XN 16384MB SODIMM DDR4 3200MT/s      | 1         | 3.23%   |
...
| Samsung RAM M471A1K44BM0-CRC 8GB SODIMM DDR4 2400MT/s           | 1         | 3.23%   |
...
| Sunplus HP HD Webcam [Fixed]                                               | 2         | 2.94%   |
| Ricoh HD Webcam                                                            | 2         | 2.94%   |
| Quanta HP TrueVision HD Camera                                             | 2         | 2.94%   |
| Microdia Laptop_Integrated_Webcam_HD                                       | 2         | 2.94%   |
| Chicony Lenovo EasyCamera                                                  | 2         | 2.94%   |
| Chicony Integrated Camera (1280x720@30)                                    | 2         | 2.94%   |
| Chicony HP Truevision HD                                                   | 2         | 2.94%   |
| Chicony HP HD Webcam [Fixed]                                               | 2         | 2.94%   |
| Chicony EasyCamera                                                         | 2         | 2.94%   |
| Cheng Uei Precision Industry (Foxlink) HP Wide Vision HD Camera            | 2         | 2.94%   |
...
| Chicony TOSHIBA Web Camera                                                 | 1         | 1.47%   |
| Cheng Uei Precision Industry (Foxlink) USB2.0 UVC VGA WebCam               | 1         | 1.47%   |
...
| Acer Lenovo EasyCamera integrated webcam                                   | 1         | 1.47%   |
| Acer Integrated Camera                                                     | 1         | 1.47%   |
| Acer EasyCamera                                                            | 1         | 1.47%   |
